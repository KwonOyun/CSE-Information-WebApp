...
public class information1{
	...
	public static void doMain() throws Exception{
		...
		t.scheduleAtFixedRate(new Crawling(), 1000, 60000);   //60초마다 주기적인 크롤링 실행
...
class Crawling extends TimerTask{    //크롤링을 실행하는 클래스
	int i = 0;
	static Document doc;
	public void run(){
		try{
			FileReader prefr = new FileReader("C:\\Users\\권오윤\\workspace\\WebTermJSP\\WebContent\\information1.json");  //원래 있던 제이슨 파일을 읽어온다.
			BufferedReader prebr = new BufferedReader(prefr);  //원래 있던 제이슨 파일을 읽어온다.
			String filename = "C:\\Users\\권오윤\\workspace\\WebTermJSP\\WebContent\\information1.json"; //새로 생성할 제이슨 파일 이름 설정
			...
			FileReader afterfr = new FileReader("C:\\Users\\권오윤\\workspace\\WebTermJSP\\WebContent\\information1.json");  //새로 완성된 제이슨 파일을 읽어온다.
	...
	public void mailsend(){
		...
		String content = "학사공지 소식이 업데이트 되었습니다!! 확인하세요!!";         //메일 내용
		String from = "oyoon33@gmail.com";  //보내는 사람 메일
		String subject = "충남대학교 컴퓨터공학과 학사공지 업데이트!!";  //메일 제목
