...
<script>
$.getJSON('information4.json',function(data) {
	var table = '<table id="header" style="margin: auto; border: 1px solid black;"><tr><td style="font-weight: bold; text-align: center; font-size:30px;">취업 정보</td><tr>';
