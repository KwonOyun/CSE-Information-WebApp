...
<video id="videobcg" preload="auto" autoplay="true" loop="loop" muted="muted">
	...
	<script>
		$.getJSON('information5.json', function(data) {
			var table = '<table id="header" style="margin: auto; border: 1px solid black;"><tr><td style="font-weight: bold; text-align: center; font-size:30px;">CSE News</td><tr>';
